...
이 글에서는 Tailwind를 단순히 “클래스를 나열하는 라이브러리”가 아니라
...
Tailwind의 핵심 엔진 `jit(Just-in-Time compiler)`는 **[content](https://github.com/nomadinsunda/reactclass/blob/main/tailwind/tailwind%20content.md) 경로에서 사용된 클래스만 CSS로 생성**합니다.
